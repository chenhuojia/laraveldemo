...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="btn-toolbar">
            <button class="btn btn-primary" onClick="location='/admin/rule/create'"><i class="icon-plus"></i>添加权限</button>
          <div class="btn-group">
          </div>
        </div>
        <div class="well">
            <table class="table">
              ...
              @foreach($rules as $k=>$item)
                <tr>
                  ...
                  <td>
                      <a href="/admin/rule/{{$item['id']}}/edit"><i class="icon-pencil"></i></a>
