    ...
    <div class="navbar">
        <div class="navbar-inner">
            <ul class="nav pull-right">
            	@if(Session::get(config('extra.admin.admin_cache_key')))
                	<li>
                        <a href="#" role="button">
                            <i class="icon-user"></i> {{Session::get(config('extra.admin.admin_cache_key'))['name']}}
                        </a>
                    </li>
                    <li><a href="/admin/logout" class="hidden-phone visible-tablet visible-desktop" role="button">Logout</a></li>
            	@else
